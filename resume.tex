...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Formulatrix, Pakistan}{Lahore, Pakistan}
      \resumeItemListStart
        \resumeItem{Working as a C\# .Net developer on backend of in-house CRM application used by Formulatrix employees.}
    \resumeItemListEnd

    \resumeSubheading
      {C Developer}{March 2024 - Present}
      {Convsync, Pakistan}{Lahore, Pakistan}
      \resumeItemListStart
    ...
    \resumeSubheading
      {Senior Software Engineer}{Aug 2021 - December 2023}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \item{
     ...
     \textbf{Developer Tools}{: PyCharm, Spyder, Jupyter Notebook, Git, VS Code, Visual Studio, Unity, Android Studio, SQL Server Management Studio} \\
