...
\resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed and optimized a high-performance, low-latency FIX engine for routing financial messages between destinations. Engine supported the FIX protocol and processed millions of messages per second for real-time trading.}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \item{
     ...
     \textbf{Languages}{: C++, C, Python, Rust, MATLAB, C\#, Java, SQL, PostgreSQL} \\
     ...
     \textbf{Libraries}{: Boost.Asio, POSIX, pandas, NumPy, Matplotlib, OpenCV, Scrappy, InfluxDB, Redis, Intel TBB} }
     }
 \end{itemize}
